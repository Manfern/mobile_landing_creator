...
p "Created #{Advantage.count} advantages blocks"


# pages_list=[
#     [
#     "Интернет магазин женских часов/украшений",
...
# advantages_list=[
#     [
#         "Доставка почтой, бандеролями 1‑го класса, в течение 5‑10 рабочих дней. Стоимость доставки товара от 350 р.",
...
#
#
#   pages_list.each do |name, title, offer, footer_text|
#     Page.create( name: name,title: title, offer: offer, footer_text: footer_text)
#   end
